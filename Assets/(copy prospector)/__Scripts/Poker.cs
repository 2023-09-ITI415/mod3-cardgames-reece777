...
public class Poker : MonoBehaviour
{
    ...
    List<CardPoker> ConvertListCardsToListCardProspectors(List<Card> lCD)
    {
    ...
    CardPoker Draw()
    {
        CardPoker cd = drawPile[0]; // Pull the 0th CardPoker
    ...
    {
        foreach (CardPoker cd in tableau)
        {
            bool faceUp = true; // Assume the card will be face-up
            foreach (CardPoker cover in cd.hiddenBy)
            {
    ...
    void MoveToDiscard(CardPoker cd)
    {
    ...
    void MoveToTarget(CardPoker cd)
    {
    ...
    public void CardClicked(CardPoker cd)
    {
    ...
    public bool AdjacentRank(CardPoker c0, CardPoker c1)
    {
